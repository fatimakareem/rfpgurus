...
describe('a date component', function () {
    var dateComponent;
    var mockDateService;
    ...
    it('should set the selected date to today when no date is set', function () {
    ...
    it('should set the selected date to 2/23/2007 and get individual days/month/year. ', function () {
    ...
    it('should change the selected date to 3/23/2007', function () {
        dateComponent.selectedDate = new Date('2/23/2007');
        expect(dateComponent.selectedMonth).toEqual(2);
    ...
    it('should change the selected date to 2/24/2007', function () {
        dateComponent.selectedDate = new Date('2/23/2007');
        expect(dateComponent.selectedMonth).toEqual(2);
    ...
    it('should change the selected date to 2/23/2017', function () {
        dateComponent.selectedDate = new Date('2/23/2007');
        expect(dateComponent.selectedMonth).toEqual(2);
    ...
    it('should change the selected date to 3/3/2017 and reload the available days', function () {
        dateComponent.selectedDate = new Date('2/23/2007');
        expect(dateComponent.selectedMonth).toEqual(2);
    ...
    it('should toggle the month selection menu', function () {
    ...
    it('should toggle the year selection menu', function () {
    ...
    it('should tell the picker to hide when closed', function () {
        dateComponent.closeDatePicker.subscribe(function (visiblility) {
            expect(visiblility).toBe(false);
        });
        dateComponent.closePicker();
    });
    describe('time component', function () {
        it('should change the selected time to 8pm', function (done) {
            dateComponent.ngOnInit();
            dateComponent.selectedDateChange.subscribe(function (selectedDate) {
                expect(selectedDate.getHours()).toBe(8);
                done();
            });
            dateComponent.setSelectedDate(dateComponent.highlightedDate, 8);
        });
        it('should change the selected time to 45 mins', function (done) {
            dateComponent.ngOnInit();
            dateComponent.selectedDateChange.subscribe(function (selectedDate) {
...
//# sourceMappingURL=C:/Code/ngx-datetimepicker/ngx-datetimepicker/src/app/date.component/date.component.spec.js.map